...
public class GoodsReceiptBody {
    String DocNo,sPONo,iCustomer,iProduct,iWarehouse,Barcode,fPOQty,fQty,Unit,iUser,sRemarks,fMinorDamageQty,sMinorRemarks,sMinorAttachment,fDamagedQty,sDamagedRemarks,sDamagedAttachment,iMinorType,iDamageType;
    ...
    public void setDocNo(String getDocNo) {
        this.DocNo = getDocNo;
    }
    ...
    public String getiMinorType() {
        return iMinorType;
    }

    public void setiMinorType(String iMinorType) {
        this.iMinorType = iMinorType;
    }

    public String getiDamageType() {
        return iDamageType;
    }

    public void setiDamageType(String iDamageType) {
        this.iDamageType = iDamageType;
    }
}
